...
//var app = require('./dashboard.module');
//app.config(dashRoutes);
dashRoutes.$inject = ['$stateProvider','$urlRouterProvider','localStorageService','authService'];
function dashRoutes($stateProvider,$urlRouterProvider,localStorageService,authService) {
    $stateProvider
        .state('app.dash',{
            url:'/dashboard',
